...
predict = dlib.shape_predictor(r"C:\Users\alokk\Documents\Drozyapp\shape_predictor_68_face_landmarks.dat")
	...
	for subject in subjects:
		...
		if ear < thresh:
			...
			if flag >= frame_check:
				...
				cv2.putText(frame, "Your eye is closed", (10, 45),
					cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
				cv2.putText(frame, "****************ALERT!****************", (10,325),
					cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
		else:
			flag = 0
			cv2.putText(frame, "Your eye is open", (10, 30),
					cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
